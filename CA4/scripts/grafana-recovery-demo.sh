...
################################################################################
# Grafana Recovery Demonstration Script
...
verify_initial_state() {
    ...
    pause_with_message "Initial state verified. Open browser to $GRAFANA_URL to see the dashboard."
}
...
verify_failure() {
    ...
    pause_with_message "Failure verified. Try accessing $GRAFANA_URL in browser (should fail)."
}
...
assess_impact() {
    ...
    pause_with_message "Impact assessed. Ready to initiate recovery."
}
...
verify_recovery() {
    ...
    pause_with_message "Recovery complete! Access $GRAFANA_URL to verify dashboard shows continuous data."
}
...
TIMELINE:
---------
Failure Injected: $FAILURE_START
Recovery Started: $RECOVERY_START
Recovery Completed: $RECOVERY_END
